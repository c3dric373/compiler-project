...
instr : 
	'if' OPENPAR expr CLOSEPAR OPENBRACE bloc CLOSEBRACE
	'if' OPENPAR expr CLOSEPAR OPENBRACE bloc CLOSEBRACE 'else' OPENBRACE bloc CLOSEBRACE
	|'while' OPENPAR expr CLOSEPAR OPENBRACE bloc CLOSEBRACE
	;
